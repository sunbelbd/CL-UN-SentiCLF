#
# nohup bash get-data-nmt-jp.sh --src en --tgt jp --reload_codes pretrain/pretrain_enjp/codes_enjp_merged --reload_vocab pretrain/pretrain_enjp/vocab_enjp_merged >logs/prepare_en-jp_mono_merged.log &
...
# # No parallel data needed for this work
...
# Not needed for JP data since it's already saved.
#
...
# # decompress monolingual data: no needed for JP data.
